...
export default class EMidTouch extends Component {
    ...
    constructor(props) {
        ...
        this.state = {
            ...
            chardID: this.props.id || 'eMidTouch',
        ...
        let option = {
            ...
            series: [
                ...
                },
                {
                    name: 'Directories',
                    stack: 2,
                    color: colorPalette.graphColors.acadiaCorp[0],
                    type: 'bar',
                    yAxisIndex: 1,
                    data: randata2
                },
                {
                    name: 'Internal Directories',
                    stack: 2,
                    color: colorPalette.graphColors.acadiaCorp[1],
                    type: 'bar',
                    yAxisIndex: 1,
                    data: randata2
                },
                {
                    name: 'Lead Gen',
                    stack: 2,
                    color: colorPalette.graphColors.acadiaCorp[2],
                    type: 'bar',
                    yAxisIndex: 1,
                    data: randata
                },
                {
                    name: 'Other',
                    stack: 2,
                    color: colorPalette.graphColors.acadiaCorp[3],
                    type: 'bar',
                    yAxisIndex: 1,
                    data: randata2
                },
                {
                    name: 'Placement',
                    stack: 2,
                    color: colorPalette.graphColors.acadiaCorp[4],
                    type: 'bar',
                    yAxisIndex: 1,
                    data: randata
                },
                {
                    name: 'Search',
                    stack: 2,
                    color: colorPalette.graphColors.acadiaCorp[5],
                    type: 'bar',
                    yAxisIndex: 1,
                    data: randata2
                },
                {
                    name: 'Search Engine',
                    stack: 2,
                    color: colorPalette.graphColors.acadiaCorp[6],
                    type: 'bar',
                    yAxisIndex: 1,
                    data: randata
                },
                {
                    name: 'Sign Up',
                    stack: 2,
                    color: colorPalette.graphColors.acadiaCorp[7],
                    type: 'bar',
                    yAxisIndex: 1,
                    data: randata2
                },
                {
                    name: 'Social',
                    stack: 2,
                    color: colorPalette.graphColors.acadiaCorp[8],
                    type: 'bar',
                    yAxisIndex: 1,
                    data: randata
                },
                {
                    name: 'Sponsorship',
                    stack: 2,
                    color: colorPalette.graphColors.acadiaCorp[9],
                    type: 'bar',
                    yAxisIndex: 1,
                    data: randata2,
                },
